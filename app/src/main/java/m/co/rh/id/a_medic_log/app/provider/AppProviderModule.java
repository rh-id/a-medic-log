...
public class AppProviderModule implements ProviderModule {
    ...
    private Navigator getNavigator(Provider provider) {
        ...
        navMap.put(Routes.PROFILE_SELECT_PAGE, (args, activity) -> new ProfileSelectPage());
        navMap.put(Routes.PROFILE_SELECT_MULTI_PAGE, (args, activity) -> new ProfileSelectPage(ProfileSelectPage.SelectionType.MULTI));
        navMap.put(Routes.IMPORT_PROFILE_SELECT_PAGE, (args, activity) -> new ImportProfileSelectPage(ImportProfileSelectPage.Args.of(args)));
