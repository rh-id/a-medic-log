...
public class NotificationSnoozeMedicineReminderReceiver extends BroadcastReceiver {
    private static final String TAG = NotificationSnoozeMedicineReminderReceiver.class.getName();
    ...
    public void onReceive(Context context, Intent intent) {
        try {
            ...
            appNotificationHandler.snoozeMedicineReminder(intent);
        } catch (Exception e) {
            ILogger logger = BaseApplication.of(context).getProvider().get(ILogger.class);
            logger.e(TAG, "Failed to handle snooze medicine reminder action", e);
        }
    }
}
